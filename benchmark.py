...
def main():
    ...
    print(f"{'='*60}")
    print(f"{'Метрика':<30} {'TT':>10} {'Base':>10} {'Разница':>10}")
    print("-" * 60)
    print(f"{'Всего параметров':<30} {tt_results['total_params']:>10,} {base_results['total_params']:>10,}")
    print(f"{'Параметры FC-слоя':<30} {tt_results['fc_params']:>10,} {base_results['fc_params']:>10,} {base_results['fc_params']/tt_results['fc_params']:>9.1f}x")
